...
/** Copies an approved revision’s contracts onto its parent component-definition after idempotent publish job. */
...
/** Restores component-definition contracts from the snapshot stored on a revision. */
